    ...
    <section>
        ...
        <div className="col-md-8">
          <div className={s.StudentInfo}>
            {StudentInfo.map((info, index) => (
              <p key={index}>{`${info.label}: ${info.value}`}</p>
            ))}
          </div>
        </div>
        <div className="col-md-2">
          <div className={s.StudentRating}>
            {StudentRating.map((rating, index) => (
      ...
      <div className={s.about}>
        <div className={s.aboutHeader}>
          <h2>{"About"}</h2>
          <p>{"Barattson Student since Oct 8, 2023"}</p>
        </div>

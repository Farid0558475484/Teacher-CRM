import {
  ...
  useWindow
} from "./chunk-KBFGMZBD.js";
import {
  CardGroup_default
} from "./chunk-JPR6CR26.js";
import {
  require_react_dom
} from "./chunk-3QTN4EH6.js";
import {
  require_prop_types
} from "./chunk-DMUDQWUI.js";
import {
  CardHeaderContext_default,
  CardImg_default,
  Card_default,
  divWithClassName_default
} from "./chunk-S6NV4PPX.js";
import {
  DEFAULT_BREAKPOINTS,
...
var DropdownButton = React25.forwardRef(({
  title,
  children,
  bsPrefix,
  rootCloseEvent,
...
var Feedback = React26.forwardRef(
  ...
  ({
    ...
    tooltip = false,
    ...props
  }, ref) => (0, import_jsx_runtime25.jsx)(Component2, {
    ...props,
    ref,
...
var FormCheckLabel = React29.forwardRef(({
  ...
  return (0, import_jsx_runtime27.jsx)("label", {
    ...props,
    ref,
...
var FormCheck = React30.forwardRef(({
  ...
  const input = (0, import_jsx_runtime28.jsx)(FormCheckInput_default, {
    ...props,
  ...
  return (0, import_jsx_runtime28.jsx)(FormContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime28.jsx)("div", {
      ...
      children: children || (0, import_jsx_runtime30.jsxs)(import_jsx_runtime29.Fragment, {
        children: [input, hasLabel && (0, import_jsx_runtime28.jsx)(FormCheckLabel_default, {
          title,
          children: label
        }), feedback && (0, import_jsx_runtime28.jsx)(Feedback_default, {
          type: feedbackType,
...
var FormGroup = React32.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
}, ref) => {
  const context3 = (0, import_react20.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var FormLabel = React33.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column)
    return (0, import_jsx_runtime33.jsx)(Col_default, {
      ref,
      as: "label",
      className: classes,
      htmlFor,
...
var FormRange = React34.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React35.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
...
var FormText = React36.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React37.forwardRef((props, ref) => (0, import_jsx_runtime37.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React38.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
var TabContext = React44.createContext(null);
...
var NavItem = React45.forwardRef((_ref, ref) => {
  let {
...
var Nav = React46.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    onSelect,
  ...
  const needsRefocusRef = (0, import_react26.useRef)(false);
  ...
  const listNode = (0, import_react26.useRef)(null);
...
var ListGroupItem = React47.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React48.forwardRef((props, ref) => {
  const {
    className,
...
function useWaitForDOMRef(ref, onResolved) {
  ...
  const [resolvedRef, setRef] = (0, import_react27.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const child = (0, import_react28.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
var AbstractModalHeader = React53.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
...
var NavbarToggle = React60.forwardRef(({
  ...
  return (0, import_jsx_runtime62.jsx)(Component2, {
    ...
    onClick: handleClick,
    "aria-label": label,
    className: (0, import_classnames42.default)(className, bsPrefix, !expanded && "collapsed"),
...
var OffcanvasToggling = React61.forwardRef(({
  ...
  return (0, import_jsx_runtime63.jsx)(TransitionWrapper_default, {
    ...
    children: (status, innerProps) => React61.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames43.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
...
var Offcanvas = React63.forwardRef(({
  ...
  const renderBackdrop = (0, import_react38.useCallback)((backdropProps) => (0, import_jsx_runtime65.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames45.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime65.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames45.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
...
var NavDropdown = React66.forwardRef(({
  ...
  return (0, import_jsx_runtime71.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames47.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime70.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react43.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime79.jsxs)(import_jsx_runtime78.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react45.cloneElement)(children, triggerProps), (0, import_jsx_runtime77.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
function useTabPanel(_ref) {
  ...
  const context3 = (0, import_react47.useContext)(TabContext_default);
  if (!context3)
...
var ToastFade = React90.forwardRef((props, ref) => (0, import_jsx_runtime101.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React92.forwardRef(({
  ...
  const context3 = (0, import_react49.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {

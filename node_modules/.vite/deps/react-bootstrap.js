...
var CarouselCaption = React23.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function renderTransition(Component2, runTransition, props) {
  if (Component2) {
    return (0, import_jsx_runtime56.jsx)(Component2, Object.assign({}, props));
  }
  if (runTransition) {
...
var Modal = (0, import_react30.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime57.jsx)(import_jsx_runtime58.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime59.jsxs)(import_jsx_runtime58.Fragment, {
...
var AbstractModalHeader = React62.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
...
var OffcanvasBody = React72.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React73.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime75.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React73.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React74.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React75.forwardRef(({
  className,
  bsPrefix,
...
var NavbarText = React78.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var NavDropdown = React80.forwardRef(({
  ...
  return (0, import_jsx_runtime85.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames61.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime84.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
...
var SplitButton = React97.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime106.jsxs)(Dropdown_default, {
  ref,
  ...props,
  ...
  children: [(0, import_jsx_runtime105.jsx)(Button_default2, {
    ...
    type,
    children: title
  }), (0, import_jsx_runtime105.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime105.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
var ToastFade = React106.forwardRef((props, ref) => (0, import_jsx_runtime116.jsx)(Fade_default, {
  ...props,
  ref,
